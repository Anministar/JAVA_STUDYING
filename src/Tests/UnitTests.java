...
//		boolean flag = service.RegisterMember(new MemberDTO(1, "member1", "1111", "이동하", "010-1111-1111", "대구광역시", "dlehdgk@gmail.com", 1));
//		if (flag) {
...
//		boolean flag = service.RegisterMember(new MemberDTO(2, "member2", "2222", "조형준", "010-2222-2222", "거창", "Joooo@gmail.com", 1));
//		if (flag) {
//			System.out.println("회원등록에 성공하셨습니다.");
//		}
//		else {
